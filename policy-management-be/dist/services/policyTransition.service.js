...
class PolicyTransitionService {
        ...
        try {
            ...
            await prisma.policyTransitionLog.create({
                data: {
                    ...
                    company_name: parentPolicy.company?.name ?? undefined,
            ...
            await (0, policy_service_1.calculateAndSetCommission)(commissionInput);
            if (commissionInput.calculated_commission_amount != null) {
                updatePayload.calculated_commission_amount =
    ...
    static async buildInPlaceUpdatePayload(parentPolicy, newPolicyData, transitionType) {
        const processedData = {
            ...newPolicyData,
            ...
            medical_condition: newPolicyData.medical_condition !== undefined
            ...
            deductible_amount_status: newPolicyData.deductible_amount_status !== undefined
                ? newPolicyData.deductible_amount_status
                : parentPolicy.deductible_amount_status || false,
            declaration_accepted: newPolicyData.declaration_accepted !== undefined
        ...
        const companyId = transitionType === 'PORTABILITY' || transitionType === 'MIGRATION'
    ...
    static async getPolicyTransitionHistory(policyId) {
        ...
        const statusTimeline = logs.map((log) => ({
