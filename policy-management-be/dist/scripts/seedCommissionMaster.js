...
exports.seedCommissionMaster = seedCommissionMaster;
...
async function seedCommissionMaster() {
    ...
    for (const row of commissionMasterSeed) {
        ...
        await prisma.commissionMaster.create({
            data: {
                category: row.category,
                sub_category: row.sub_category,
                commission_percentage: new client_1.Prisma.Decimal(row.commission_percentage),
                is_active: true,
            },
        });
...
exports.default = seedCommissionMaster;
